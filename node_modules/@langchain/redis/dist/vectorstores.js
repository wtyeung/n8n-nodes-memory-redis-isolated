...
export class RedisVectorStore extends VectorStore {
            ...
            switch (fieldConfig.type) {
                ...
                case SchemaFieldTypes.TAG:
                    if (typeof value !== "string" && !Array.isArray(value)) {
                        throw new Error(`Metadata field '${fieldName}' must be a string or array, got ${typeof value}`);
                    }
                    break;
    ...
    constructor(embeddings, _dbConfig) {
        ...
        Object.defineProperty(this, "customSchema", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    async addVectors(vectors, documents, { keys, batchSize = 1000 } = {}) {
        ...
        const lastKeyCount = parseInt(info.numDocs ||
    ...
    async checkIndexExists() {
        try {
            ...
            if (err?.message.includes("unknown command")) {
                throw new Error("Failed to run FT.INFO command. Please ensure that you are running a RediSearch-capable Redis instance: https://js.langchain.com/docs/integrations/vectorstores/redis/#setup");
            }
            // index doesn't exist
            return false;
        }
